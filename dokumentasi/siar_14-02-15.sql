...
--
-- Inang: 127.0.0.1
-- Waktu pembuatan: 14 Feb 2015 pada 04.42
-- Versi Server: 5.6.14
-- Versi PHP: 5.5.6
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14745 ;
...
('80453254', 27, '2015-11-07', 'BPV10084891', 'BPV 114768 ADV I NYOMAN DIATMIKA BY MEETING SEPT & OKT 2013 PD:1273', 2100000, 0, 'Exp belum kirim', 14709, '2015-10-31'),
('80453254', 27, '2013-11-07', 'BPV10086283', 'BPV 114938 ADV I NYOMAN DIATMIKA BY KUNJUNGAN CABANG & MEETING DI HO NOP 2013 PD:1283', 7000000, 0, 'Exp belum kirim', 14710, '2015-10-31'),
('80453254', 27, '2013-11-19', 'GJV100051294', 'Disapproved EEX1-21808 Airport lounge PD:1197', 75000, 0, 'Exp belum kirim', 14711, '2015-01-31'),
('80453254', 27, '2013-11-19', 'GJV100051295', 'Disapproved EEX1-21809 Airport lounge PD:1218', 44000, 0, 'Exp belum kirim', 14712, '2015-01-31'),
('80453254', 19, '2013-11-29', 'EEX10022769', 'By perjalanan meeting AOM E2 Okt''13 BPV10084891', 0, 2148000, 'Exp belum kirim', 14713, '2015-01-31'),
('80453254', 19, '2014-01-17', 'BPV14000854', 'BPV 115870 ADV I NYOMAN DIATMIKA BY TRAVELLING KE CAB.27.68 JAN 2014 PD:1334', 5150000, 0, 'Exp belum kirim', 14714, '2015-01-31'),
('80453254', 19, '2014-01-27', 'EEX14000187', 'By traveling AOM E2 Nov''13 BPV10086283', 0, 6594000, 'Exp belum kirim', 14715, '2015-01-31'),
('80453254', 19, '2014-01-27', 'EEX14000188', 'By traveling AOM E2 Des''13', 0, 1690000, 'Exp belum kirim', 14716, '2015-01-31'),
('80453254', 19, '2014-02-19', 'GJV140000928', 'Kor. Saldo Business to Personal', 0, 9592430, 'Exp belum kirim', 14717, '2015-01-31'),
('73540071', 27, '2015-11-07', 'BPV10084891', 'BPV 114768 ADV I NYOMAN DIATMIKA BY MEETING SEPT & OKT 2013 PD:1273', 2100000, 0, 'Exp belum kirim', 14718, '2015-10-31'),
('73540071', 27, '2013-11-07', 'BPV10086283', 'BPV 114938 ADV I NYOMAN DIATMIKA BY KUNJUNGAN CABANG & MEETING DI HO NOP 2013 PD:1283', 7000000, 0, 'Exp belum kirim', 14719, '2015-10-31'),
('73540071', 27, '2013-11-19', 'GJV100051294', 'Disapproved EEX1-21808 Airport lounge PD:1197', 75000, 0, 'Exp belum kirim', 14720, '2015-01-31'),
('73540071', 27, '2013-11-19', 'GJV100051295', 'Disapproved EEX1-21809 Airport lounge PD:1218', 44000, 0, 'Exp belum kirim', 14721, '2015-01-31'),
('73540071', 19, '2013-11-29', 'EEX10022769', 'By perjalanan meeting AOM E2 Okt''13 BPV10084891', 0, 2148000, 'Exp belum kirim', 14722, '2015-01-31'),
('73540071', 19, '2014-01-17', 'BPV14000854', 'BPV 115870 ADV I NYOMAN DIATMIKA BY TRAVELLING KE CAB.27.68 JAN 2014 PD:1334', 5150000, 0, 'Exp belum kirim', 14723, '2015-01-31'),
('73540071', 19, '2014-01-27', 'EEX14000187', 'By traveling AOM E2 Nov''13 BPV10086283', 0, 6594000, 'Exp belum kirim', 14724, '2015-01-31'),
('73540071', 19, '2014-01-27', 'EEX14000188', 'By traveling AOM E2 Des''13', 0, 1690000, 'Exp belum kirim', 14725, '2015-01-31'),
('73540071', 19, '2014-02-19', 'GJV140000928', 'Kor. Saldo Business to Personal', 0, 9592430, 'Exp belum kirim', 14726, '2015-01-31'),
('80315504', 27, '2015-11-07', 'BPV10084891', 'BPV 114768 ADV I NYOMAN DIATMIKA BY MEETING SEPT & OKT 2013 PD:1273', 2100000, 0, 'Exp belum kirim', 14727, '2015-10-31'),
('80315504', 27, '2013-11-07', 'BPV10086283', 'BPV 114938 ADV I NYOMAN DIATMIKA BY KUNJUNGAN CABANG & MEETING DI HO NOP 2013 PD:1283', 7000000, 0, 'Exp belum kirim', 14728, '2015-10-31'),
('80315504', 27, '2013-11-19', 'GJV100051294', 'Disapproved EEX1-21808 Airport lounge PD:1197', 75000, 0, 'Exp belum kirim', 14729, '2015-10-31'),
('80315504', 27, '2013-11-19', 'GJV100051295', 'Disapproved EEX1-21809 Airport lounge PD:1218', 44000, 0, 'Exp belum kirim', 14730, '2015-10-31'),
('80315504', 19, '2013-11-29', 'EEX10022769', 'By perjalanan meeting AOM E2 Okt''13 BPV10084891', 0, 2148000, 'Exp belum kirim', 14731, '2015-10-31'),
('80315504', 19, '2014-01-17', 'BPV14000854', 'BPV 115870 ADV I NYOMAN DIATMIKA BY TRAVELLING KE CAB.27.68 JAN 2014 PD:1334', 5150000, 0, 'Exp belum kirim', 14732, '2015-10-31'),
('80315504', 19, '2014-01-27', 'EEX14000187', 'By traveling AOM E2 Nov''13 BPV10086283', 0, 6594000, 'Exp belum kirim', 14733, '2015-10-31'),
('80315504', 19, '2014-01-27', 'EEX14000188', 'By traveling AOM E2 Des''13', 0, 1690000, 'Exp belum kirim', 14734, '2015-10-31'),
('80315504', 19, '2014-02-19', 'GJV140000928', 'Kor. Saldo Business to Personal', 0, 9592430, 'Exp belum kirim', 14735, '2015-10-31'),
('80315504', 27, '2015-11-07', 'BPV10084891', 'BPV 114768 ADV I NYOMAN DIATMIKA BY MEETING SEPT & OKT 2013 PD:1273', 2100000, 0, 'Exp belum kirim', 14736, '2015-10-31'),
('80315504', 27, '2013-11-07', 'BPV10086283', 'BPV 114938 ADV I NYOMAN DIATMIKA BY KUNJUNGAN CABANG & MEETING DI HO NOP 2013 PD:1283', 7000000, 0, 'Exp belum kirim', 14737, '2015-10-31'),
('80315504', 27, '2013-11-19', 'GJV100051294', 'Disapproved EEX1-21808 Airport lounge PD:1197', 75000, 0, 'Exp belum kirim', 14738, '2015-01-31'),
('80315504', 27, '2013-11-19', 'GJV100051295', 'Disapproved EEX1-21809 Airport lounge PD:1218', 44000, 0, 'Exp belum kirim', 14739, '2015-01-31'),
('80315504', 19, '2013-11-29', 'EEX10022769', 'By perjalanan meeting AOM E2 Okt''13 BPV10084891', 0, 2148000, 'Exp belum kirim', 14740, '2015-01-31'),
('80315504', 19, '2014-01-17', 'BPV14000854', 'BPV 115870 ADV I NYOMAN DIATMIKA BY TRAVELLING KE CAB.27.68 JAN 2014 PD:1334', 5150000, 0, 'Exp belum kirim', 14741, '2015-01-31'),
('80315504', 19, '2014-01-27', 'EEX14000187', 'By traveling AOM E2 Nov''13 BPV10086283', 0, 6594000, 'Exp belum kirim', 14742, '2015-01-31'),
('80315504', 19, '2014-01-27', 'EEX14000188', 'By traveling AOM E2 Des''13', 0, 1690000, 'Exp belum kirim', 14743, '2015-01-31'),
('80315504', 19, '2014-02-19', 'GJV140000928', 'Kor. Saldo Business to Personal', 0, 9592430, 'Exp belum kirim', 14744, '2015-01-31');
...
CREATE TABLE IF NOT EXISTS `data_komplain` (
  `id_komplain` int(5) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `data_komplain` (`id_komplain`, `nip`, `voucher`, `period`, `isi_komplain`) VALUES
(1, '', 'dsfg', '0000-00-00', '	asg					'),
(2, '', 'gjsdg', '0000-00-00', '	sdfgsdfg					'),
(3, '', 'asdf', '0000-00-00', '	sf					'),
(4, '80315504', 'asdf', '2015-02-28', '	sadf					'),
(5, '80315504', 'sdfg', '2015-01-31', '	sdfg					');
...
--
-- Stand-in structure for view `summary_data_komplain`
--
CREATE TABLE IF NOT EXISTS `summary_data_komplain` (
`nip` varchar(20)
,`period` date
,`voucher` varchar(20)
,`isi_komplain` text
...
--
-- Struktur untuk view `summary_data_komplain`
--
DROP TABLE IF EXISTS `summary_data_komplain`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `summary_data_komplain` AS select `data_komplain`.`nip` AS `nip`,`data_komplain`.`period` AS `period`,`data_komplain`.`voucher` AS `voucher`,`data_komplain`.`isi_komplain` AS `isi_komplain`,`user`.`nama` AS `nama`,`user`.`id_cab` AS `id_cab` from (`data_komplain` join `user`) where (`data_komplain`.`nip` = `user`.`nip`);
